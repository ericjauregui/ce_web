...
class FrontendContractTests(BaseWebTest):
    ...
    def test_nav_search_clear_logic_uses_input_and_search_events(self) -> None:
        ...
        self.assertIn("function maybeSubmitOrClearSearch()", body)
        self.assertIn("input.addEventListener(\"search\", maybeSubmitOrClearSearch)", body)
        self.assertIn("input.addEventListener(\"input\", maybeClearSearch)", body)
        self.assertIn("form.addEventListener(\"submit\", (e) => {", body)
    ...
    def test_page_titles_keep_centered_grid_layout_and_centered_back_button(self) -> None:
        ...
        self.assertIn(">Jewelry Reels</h1>", reels_body)
        ...
        self.assertIn("class=\"checkout-summary-bar__left\"", checkout_body)
        self.assertIn("class=\"btn btn-outline-gold checkout-summary-back-btn\" href=\"/cart\"", checkout_body)
